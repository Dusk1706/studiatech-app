        ...
        <>
            {gigData && (
                ...
                <div className="border p-10 flex flex-col gap-5"> 
                    ...
                    <h4 className="text-md font-normal textm.[#74767e]">
                      {gigData.shortDesc}
                      </h4>
                      <h6 className="font-medium text-lg">${gigData.price}</h6>
                </div>
                <div>
                    <div className="text-[#62644a] font-semibold text-sm flex gap-6">
                        <div className="flex items-center gap-2">
                            <FiClock className="text-xl"/>
                            <span>{gigData.deliveryTime} Days Deliver</span>
                        </div>
                        <div className="flex items-center gap-2">
                ...
                >
                    <span>Edit</span>
                    <BiRightArrowAlt className="text-2xl absolute right-4"></BiRightArrowAlt>
                    </button>
                    ) : (
                        <button
                        className="flex items-center bg-[#1DBF73] text-white py-2 justify-center font-bold text-lg relative rounded"
