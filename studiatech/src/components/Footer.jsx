  ...
  const data = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Selling on StudiaTech", link: "#" },
        { name: "Buying on StudiaTech", link: "#" },
      ],
    },
    {
    ...
    {
      headerName: "Move From StudiaTech",
      links: [
        { name: "StudiaTech Business", link: "#" },
        { name: "StudiaTech Pro", link: "#" },
        { name: "StudiaTech Logo Maker", link: "#" },
        { name: "StudiaTech Guides", link: "#" },
        { name: "Get Inspired", link: "#" },
        { name: "StudiaTech Select", link: "#" },
        { name: "ClearVoice", link: "#" },
        { name: "StudiaTech Workspace", link: "#" },
        { name: "Learn", link: "#" },
